...
int main(int argc, const char * argv[]) {
    ...
    std::string vsPath = currentpath + "/basiclightingspecular.vs";
    std::string fsPath = currentpath + "/basiclightingspecular.fs";
    std::string lightvsPath = currentpath + "/light_basiclightingspecular.vs";
    std::string lightfsPath = currentpath + "/light_basiclightingspecular.fs";
