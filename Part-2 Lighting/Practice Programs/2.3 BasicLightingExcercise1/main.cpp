...
int main(int argc, const char * argv[]) {
    ...
    std::string currentpath = "/Documents/OpenGL/OpenGL-Programs/Part-2 Lighting/Practice Programs/2.3 BasicLightingExcercise1/";
    // Setting the paths of vertex and fragment shaders
    std::string vsPath = homepath + currentpath + "basiclightingexcercise1.vs";
    std::string fsPath = homepath + currentpath + "basiclightingexcercise1.fs";
    std::string lightvsPath = homepath + currentpath + "light_basiclightingexcercise1.vs";
    std::string lightfsPath = homepath + currentpath + "light_basiclightingexcercise1.fs";
   ...
   float vertices[] = {
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        // move the lighting cube position
