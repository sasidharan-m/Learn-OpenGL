...
int main(int argc, const char * argv[]) {
    ...
    std::string vsPath = currentpath + "/basiclightingexcercise1.vs";
    std::string fsPath = currentpath + "/basiclightingexcercise1.fs";
    std::string lightvsPath = currentpath + "/light_basiclightingexcercise1.vs";
    std::string lightfsPath = currentpath + "/light_basiclightingexcercise1.fs";
