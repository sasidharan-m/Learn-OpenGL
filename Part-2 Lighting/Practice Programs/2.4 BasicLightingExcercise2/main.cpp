...
int main(int argc, const char * argv[]) {
    ...
    std::string currentpath = "/Documents/OpenGL/OpenGL-Programs/Part-2 Lighting/Practice Programs/2.4 BasicLightingExcercise2/";
    // Setting the paths of vertex and fragment shaders
    std::string vsPath = homepath + currentpath + "basiclightingexcercise2.vs";
    std::string fsPath = homepath + currentpath + "basiclightingexcercise2.fs";
    std::string lightvsPath = homepath + currentpath + "light_basiclightingexcercise2.vs";
    std::string lightfsPath = homepath + currentpath + "light_basiclightingexcercise2.fs";
