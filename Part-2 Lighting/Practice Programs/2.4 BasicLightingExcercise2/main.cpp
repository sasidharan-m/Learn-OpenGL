...
int main(int argc, const char * argv[]) {
    ...
    std::string vsPath = currentpath + "/basiclightingexcercise2.vs";
    std::string fsPath = currentpath + "/basiclightingexcercise2.fs";
    std::string lightvsPath = currentpath + "/light_basiclightingexcercise2.vs";
    std::string lightfsPath = currentpath + "/light_basiclightingexcercise2.fs";
