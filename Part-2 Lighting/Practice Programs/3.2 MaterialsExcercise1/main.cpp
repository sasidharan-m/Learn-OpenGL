//
//  main.cpp
//  Materials Excericse 1
//
//  Created by  Sasidharan Mahalingam on 02/08/25.
//
...
int main(int argc, const char * argv[]) {
    ...
    std::string vsPath = currentpath + "/materials.vs";
    std::string fsPath = currentpath + "/materials.fs";
   ...
   float vertices[] = {
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        lightingOurShader.setVec3("color", lightColor);
