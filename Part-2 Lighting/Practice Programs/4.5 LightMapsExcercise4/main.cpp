...
int main(int argc, const char * argv[]) {
    ...
    std::string vsPath = currentpath + "/emissionmap.vs";
    std::string fsPath = currentpath + "/emissionmap.fs";
   ...
   float vertices[] = {
    ...
    std::string specularMapPath = projectpath + "/resources/container2_specular.png";
    unsigned int specularMap = loadTexture(specularMapPath.c_str());
    
    // load emission map as texture
    std::string emissionMapPath = projectpath + "/resources/matrix.jpg";
