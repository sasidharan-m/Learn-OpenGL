...
int main(int argc, const char * argv[]) {
    ...
    std::string vsPath = currentpath + "/basiclightingexcercise3.vs";
    std::string fsPath = currentpath + "/basiclightingexcercise3.fs";
    std::string lightvsPath = currentpath + "/light_basiclightingexcercise3.vs";
    std::string lightfsPath = currentpath + "/light_basiclightingexcercise3.fs";
