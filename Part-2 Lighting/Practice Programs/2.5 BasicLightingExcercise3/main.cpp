...
int main(int argc, const char * argv[]) {
    ...
    std::string currentpath = "/Documents/OpenGL/OpenGL-Programs/Part-2 Lighting/Practice Programs/2.5 BasicLightingExcercise3/";
    // Setting the paths of vertex and fragment shaders
    std::string vsPath = homepath + currentpath + "basiclightingexcercise3.vs";
    std::string fsPath = homepath + currentpath + "basiclightingexcercise3.fs";
    std::string lightvsPath = homepath + currentpath + "light_basiclightingexcercise3.vs";
    std::string lightfsPath = homepath + currentpath + "light_basiclightingexcercise3.fs";
