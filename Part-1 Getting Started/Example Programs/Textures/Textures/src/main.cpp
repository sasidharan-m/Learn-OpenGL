...
int main(int argc, const char * argv[]) {
    ...
    std::string currentpath = "/Documents/OpenGL/Learn OpenGL/OpenGL-Programs/Part-1 Getting Started/Example Programs/Textures/Textures/";
    ...
    std::string texturePath = homepath + currentpath + "resources/container.jpg";
