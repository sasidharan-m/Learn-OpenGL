...
int main(int argc, const char * argv[]) {
    ...
    std::string currentpath = "/Documents/OpenGL/OpenGL-Programs/Part-1 Getting Started/Example Programs/Transformations/Transformations/";
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        float scale_factor = glm::abs(glm::sin((float)glfwGetTime()));
        transform2 = glm::scale(transform2, glm::vec3(scale_factor, scale_factor, scale_factor));
