...
int main(int argc, const char * argv[]) {
    ...
    // send the offset to the uniform location
    int uniformTransLocation = glGetUniformLocation(shaderProgram, "xOffset");
    if(uniformTransLocation < 0)
    {
        std::cout << "ERROR::SHADER::PROGRAM::UNABLE_TO_GET_UNIFORM_VARIABLE\n" << std::endl;
        return -1;
    }
    glUniform1f(uniformTransLocation, -0.5f);
