...
//  TexturesExcercise1
//
//  Created by Sasidharan Mahalingam on 3/9/23.
//
...
// declare the global variable that defines the amount of transperancy between the two textures
float mixvalue = 2.0;
...
int main(int argc, const char * argv[]) {
    ...
    std::string currentpath = "/Documents/OpenGL/OpenGL-Programs-CMake/Part-1 Getting Started/Practice Programs/4.6 TexturesExcercise4/";
