//
//  main.cpp
//  TransformationsExcercise2
//
//  Created by  Sasidharan Mahalingam on 23/03/23.
//
...
int main(int argc, const char * argv[]) {
    ...
    std::string currentpath = "/Documents/OpenGL/OpenGL-Programs/Part-1 Getting Started/Practice Programs/TransformationsExcercise2/TransformationsExcercise2/";
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        // create transformations for the first box
        ...
        // create transformations for the second box
        transform = glm::mat4(1.0f);
        float scale_amount = sin((double)glfwGetTime());
        transform = glm::translate(transform, glm::vec3(-0.5f, 0.5f, 0.0f));
        transform = glm::scale(transform, glm::vec3(scale_amount, scale_amount, scale_amount));
        // render container
        ourShader.use();
        transformLoc = glGetUniformLocation(ourShader.getProgramID(), "transform");
        glUniformMatrix4fv(transformLoc, 1, GL_FALSE, glm::value_ptr(transform));
        glBindVertexArray(VAO);
        glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0);
